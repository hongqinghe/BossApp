...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            Glide.with(context).load(EaseUserUtils.usericon)
                    .transform(new CircleTransform(context))
                    .into(userAvatarView);
//            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
        }else{
            Glide.with(context).load(message.getStringAttribute("myPrice",""))
                    .transform(new CircleTransform(context))
                    .into(userAvatarView);
            usernickView.setText(message.getStringAttribute("myName",""));
//            EaseUserUtils.setUserAvatar(context, message.getStringAttribute("userPic",""), userAvatarView);
//            EaseUserUtils.setUserNick(message.getStringAttribute("userName",""), usernickView);
        }
