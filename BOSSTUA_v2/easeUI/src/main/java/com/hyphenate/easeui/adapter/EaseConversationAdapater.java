...
import com.hyphenate.easeui.widget.chatrow.CircleTransform;
...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (username.equals(userId.toLowerCase())){
            Glide.with(getContext()).load(conversation.getLastMessage().getStringAttribute("otherPrice",""))
                    .transform(new CircleTransform(getContext()))
                    .into(holder.avatar);
            holder.name.setText(conversation.getLastMessage().getStringAttribute("otherName",""));
        }else{
            Glide.with(getContext()).load(conversation.getLastMessage().getStringAttribute("myPrice",""))
                    .transform(new CircleTransform(getContext()))
                    .into(holder.avatar);
            holder.name.setText(conversation.getLastMessage().getStringAttribute("myName",""));
