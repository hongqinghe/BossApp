...
public class MyCityCodeUtil {
     ...
     * 单例
     */
    public static MyCityCodeUtil model;
    private Context context;

    private MyCityCodeUtil() {
    }
     ...
     * 获取单例
     */
    public static MyCityCodeUtil getSingleton() {
        if (null == model) {
            model = new MyCityCodeUtil();
        }
        return model;
    }

    public ArrayList<String> getProvince(List<MyCityinfo> provice) {
    ...
    public ArrayList<String> getCity(HashMap<String, List<MyCityinfo>> cityHashMap, String provicecode) {
        ...
        List<MyCityinfo> city = new ArrayList<MyCityinfo>();
    ...
    public ArrayList<String> getCouny(HashMap<String, List<MyCityinfo>> cityHashMap, String citycode) {
        System.out.println("citycode" + citycode);
        List<MyCityinfo> couny = null;
        ...
        if (couny == null) {
            couny = new ArrayList<MyCityinfo>();
        } else {
            couny.clear();
        }
