...
//        return 3;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_companyBrand = (TextView) convertView.findViewById(R.id.tv_companyBrand);
        ...
        holder.tv_companyBrand.setVisibility(View.VISIBLE);
        holder.tv_attention_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onAttentionListener.doCheck01(position);
            }
        });
        ...
        if (dataList.get(position).getAttentionIsOff() == 1) {
            holder.tv_attention_button.setText("取消关注");
        ...
        holder.tv_companyBrand.setText(dataList.get(position).getCompanyBrand());
