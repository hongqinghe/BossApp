...
import com.android.app.buystore.utils.MyCityCodeUtil;
import com.android.app.buystore.utils.MyFileUtil;
import com.android.app.buystoreapp.setting.MyScrollerNumberPicker.OnSelectListener;
import com.android.app.buystoreapp.R;
import com.android.app.buystoreapp.bean.MyCityinfo;
...
public class MyCityPicker extends LinearLayout {
	/** 滑动控件 */
	private MyScrollerNumberPicker provincePicker;
	private MyScrollerNumberPicker cityPicker;
	private MyScrollerNumberPicker counyPicker;
	/** 选择监听 */
	...
	private List<MyCityinfo> province_list = new ArrayList<MyCityinfo>();
	private HashMap<String, List<MyCityinfo>> city_map = new HashMap<String, List<MyCityinfo>>();
	private HashMap<String, List<MyCityinfo>> couny_map = new HashMap<String, List<MyCityinfo>>();
	...
	private MyCityCodeUtil citycodeUtil;
	private String city_code_string;
	private String city_string;
	private String ctiyname;


	public MyCityPicker(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void getAddressInfo() {
		...
		String area_str = MyFileUtil.readAssets(context, "area.json");
	...
	public static class JSONParser {
		...
		public List<MyCityinfo> getJSONParserResult(String JSONString, String key) {
			List<MyCityinfo> list = new ArrayList<MyCityinfo>();
		...
		public HashMap<String, List<MyCityinfo>> getJSONParserResultArray(String JSONString, String key) {
			HashMap<String, List<MyCityinfo>> hashMap = new HashMap<String, List<MyCityinfo>>();
			JsonObject result = new JsonParser().parse(JSONString).getAsJsonObject().getAsJsonObject(key);
			Iterator iterator = result.entrySet().iterator();
			while (iterator.hasNext()) {
				Entry<String, JsonElement> entry = (Entry<String, JsonElement>) iterator.next();
	...
	protected void onFinishInflate() {
		...
		citycodeUtil = MyCityCodeUtil.getSingleton();
		// 获取控件引用
		provincePicker = (MyScrollerNumberPicker) findViewById(R.id.province);
		cityPicker = (MyScrollerNumberPicker) findViewById(R.id.city);
		counyPicker = (MyScrollerNumberPicker) findViewById(R.id.couny);
