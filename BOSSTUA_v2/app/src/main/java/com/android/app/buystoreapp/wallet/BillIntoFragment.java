 ...
 */
public class BillIntoFragment extends Fragment implements View.OnClickListener{
    private View view;
    ...
    public BillIntoFragment() {
    }

    @SuppressLint("ValidFragment")
    public BillIntoFragment(List<BilDetailsBean> datas) {
        this.datas = datas;
    }
