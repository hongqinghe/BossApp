 ...
 */
public class BillCostFragment extends Fragment implements View.OnClickListener{
    private View view;
    ...
    public BillCostFragment() {
    }

    @SuppressLint("ValidFragment")
    public BillCostFragment(List<BilDetailsBean> datas) {
        this.datas = datas;
    }
